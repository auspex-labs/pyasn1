...
latex_documents = [
    (master_doc, "PyASN1.tex", "PyASN1 Documentation", "Ilya Etingof \\textless{}etingof@gmail.com\\textgreater{}", "manual"),
]
...
texinfo_documents = [
    (master_doc, "PyASN1", "PyASN1 Documentation", author, "PyASN1", "One line description of project.", "Miscellaneous"),
]
