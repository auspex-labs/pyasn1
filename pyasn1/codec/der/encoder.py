    ...
    def _componentSortKey(componentAndType):
        ...
        if compType.typeId == univ.Choice.typeId and not compType.tagSet:
            if asn1Spec is None:
                ...
                names = [namedType.name for namedType in asn1Spec.componentType.namedTypes if namedType.name in component]
                if len(names) != 1:
                    raise error.PyAsn1Error("%s components for Choice at %r" % (len(names) and "Multiple " or "None ", component))
