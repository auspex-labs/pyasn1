...
class GeneralizedTimeTestCase(BaseTestCase):
    ...
    def testToDateTime4(self):
        assert (
            datetime.datetime(2017, 7, 11, 0, 1, 2, 3000, tzinfo=UTC) == useful.GeneralizedTime("20170711000102.3+0000").asDateTime
        )

    def testToDateTime5(self):
        assert (
            datetime.datetime(2017, 7, 11, 0, 1, 2, 3000, tzinfo=UTC2) == useful.GeneralizedTime("20170711000102.3+0200").asDateTime
        )

    def testToDateTime6(self):
        assert (
            datetime.datetime(2017, 7, 11, 0, 1, 2, 3000, tzinfo=UTC2) == useful.GeneralizedTime("20170711000102.3+02").asDateTime
        )
